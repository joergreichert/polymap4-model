...
import org.polymap.model2.test.ComplexQueryTest;
 ...
 */
public class LuceneComplexQueryTest
        extends ComplexQueryTest {

    private static final Log log = LogFactory.getLog( LuceneComplexQueryTest.class );

    protected IRecordStore          store;

    
    public LuceneComplexQueryTest( String name ) {
        super( name );
    }
