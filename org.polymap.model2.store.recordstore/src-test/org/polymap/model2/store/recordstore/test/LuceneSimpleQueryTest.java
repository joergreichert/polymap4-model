...
import org.polymap.model2.test.SimpleQueryTest;
...
public class LuceneSimpleQueryTest
    ...
    private static final Log log = LogFactory.getLog( LuceneSimpleQueryTest.class );

    protected IRecordStore          store;

    
    public LuceneSimpleQueryTest( String name ) {
        super( name );
    }
